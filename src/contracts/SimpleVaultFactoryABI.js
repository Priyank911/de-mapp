// New ABI for SimpleVaultFactory contract - DEPLOYED VERSION
export const SIMPLE_VAULT_FACTORY_ABI = [
  {
    "inputs": [],
    "name": "createVault",
    "outputs": [
...
// Method signatures for the new contract
export const SIMPLE_VAULT_METHOD_SIGNATURES = {
