...
/**
 * @title DataStorage
 * @dev Smart contract for storing user data (email, UUID, CID) on Push Network (Donuts Testnet)
 * @author De-MAPP Protocol Team
 */
contract DataStorage is Ownable, ReentrancyGuard {
    
    // Storage fee in PUSH (0.01 PUSH = 10^16 wei)
